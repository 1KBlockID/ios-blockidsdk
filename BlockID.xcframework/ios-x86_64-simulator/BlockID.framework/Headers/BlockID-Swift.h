...
#ifndef BLOCKID_SWIFT_H
#define BLOCKID_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="BlockID",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC7BlockID21BIDNewSessionResponse")
...
SWIFT_CLASS("_TtC7BlockID14BIDScannerView")
...
SWIFT_CLASS("_TtC7BlockID19BIDServiceDirectory")
@interface BIDServiceDirectory : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC7BlockID8BIDVault")
...
SWIFT_CLASS("_TtC7BlockID10BlockIDSDK")
...
SWIFT_CLASS("_TtC7BlockID13DigitalAssets")
...
@interface DocumentScannerViewController (SWIFT_EXTENSION(BlockID)) <SFSafariViewControllerDelegate>
- (void)safariViewControllerDidFinish:(SFSafariViewController * _Nonnull)controller;
@end


SWIFT_CLASS("_TtC7BlockID23DriverLicenseScanHelper")
...
SWIFT_CLASS("_TtC7BlockID13ErrorResponse")
...
SWIFT_CLASS("_TtC7BlockID20NationalIDScanHelper")
...
SWIFT_CLASS("_TtC7BlockID18PassportScanHelper")
