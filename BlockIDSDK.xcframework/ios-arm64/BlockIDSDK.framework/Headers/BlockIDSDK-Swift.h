...
#ifndef BLOCKIDSDK_SWIFT_H
#define BLOCKIDSDK_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="BlockIDSDK",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif

#if defined(__OBJC__)

SWIFT_CLASS("_TtC10BlockIDSDK20AccountAuthConstants")
@interface AccountAuthConstants : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC10BlockIDSDK17BIDNetworkManager")
...
SWIFT_CLASS("_TtC10BlockIDSDK19BIDServiceDirectory")
@interface BIDServiceDirectory : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC10BlockIDSDK8BIDVault")
@interface BIDVault : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
SWIFT_CLASS("_TtC10BlockIDSDK13BlockIDModule")
@interface BlockIDModule : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
SWIFT_CLASS("_TtC10BlockIDSDK13DigitalAssets")
@interface DigitalAssets : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC10BlockIDSDK23DriverLicenseScanHelper")
@interface DriverLicenseScanHelper : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
SWIFT_CLASS("_TtC10BlockIDSDK13ErrorResponse")
...
SWIFT_CLASS("_TtC10BlockIDSDK19LiveIDScannerHelper")
...
SWIFT_CLASS("_TtC10BlockIDSDK14PassportReader") SWIFT_AVAILABILITY(ios,introduced=13)
...
SWIFT_CLASS("_TtC10BlockIDSDK18PassportScanHelper")
@interface PassportScanHelper : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
SWIFT_CLASS("_TtC10BlockIDSDK15QRScannerHelper")
...
SWIFT_CLASS("_TtC10BlockIDSDK9TOTPUtils")
