...
The BlockID SDK is now available as .xcframework. Application must remove the run script which was required to remove unwanted architecture during app deployment process.
  ...
  s.source           = { :git => 'https://github.com/1KBlockID/ios-blockidsdk.git', :tag => 'bid_sdk_1.8.30.v3' }
  ...
  s.vendored_frameworks = 'BlockIDSDK.xcframework', 'Sub-frameworks/IDMetricsSelfieCapture.xcframework', 'Sub-frameworks/CFDocumentScanSDK.xcframework'
