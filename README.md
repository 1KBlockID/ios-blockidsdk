...
# Change Logs
- v1.4.98
1. Buf fix - LiveID scan should reset when user's face is out of focus
...
- v1.4.96
1. Bug fix - SDK notifies wrongExpressionDetected() delegate to app when shouldResetOnWrongExpresssion is set to false
