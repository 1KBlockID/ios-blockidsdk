...
3. In the search bar, enter the repository URL:
   ...
   ```
4. Set the **Dependency Rule** to **Exact Version** and enter `1.30.60` (or the desired version).
5. Click **Add Package**.
...
```swift
dependencies: [
    .package(url: "https://github.com/1KBlockID/ios-blockidsdk.git", exact: "1.30.60")
]
```
